...
module.exports = function(context) {
    ...
    var frameworkFilesToEmbed = fromDir(pluginPathInPlatformIosDir ,'.xcframework', false, true);
    if(!frameworkFilesToEmbed.length) frameworkFilesToEmbed = fromDir(pluginPathInPlatformIosDir ,'.framework', false, true);
    process.chdir('../../');
